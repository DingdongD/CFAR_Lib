...
% 本程序主要研究多目标情况下SO-CFAR关于信噪比的检测性能
...
title('\fontname{Times New Roman}r\fontname{宋体}个干扰目标情况下\fontname{Times New Roman}SO-CAFR\fontname{宋体}检测概率\fontname{Times New Roman}(N=36,Pfa=1e-6)');h = legend('r=2','r=5','r=10','Location','SouthEast','NumColumns',1);h = legend('r=(0,1)','r=(0,2)','r=(1,1)','Location','SouthEast','NumColumns',1);
